...
@Component({
  ...
  template: `
    ...
    <div
      ...
      style="
      background-image: url('../../assets/jd-image.jpg');
      height: 100vh;
    "
    >
      <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
        <div class="d-flex justify-content-center align-items-center h-100">
          <div class="text-white w-50 mt-5 mb-5">
            <svg
              height="100"
            ...
            <h4 class="mb-3 mt-5">
              Mixer Pro DJ, console, lettori, cuffie, software, strumenti per la
              produzione e altro. Effettua l'acquisto oggi stesso: dai un tocco
              in più alle tue performance! Eleva le tue performance. Impara
              subito il DJing. Apparecchiature Pro DJ.
            </h4>
            <button
